...
<head>
    <meta charset="UTF-8">
    <title>Properties for Sale - Real Estate</title>
    <style>
        ...
        .property-price { font-size: 24px; font-weight: bold; color: #28a745; margin-bottom: 10px; }
            ...
            <?php foreach ($properties as $property): ?>
                <a href="full_details.php?id=<?= $property['property_id'] ?>" style="text-decoration: none; color: inherit;">
                    <div class="property-card">
                        <img class="property-img" src="<?= !empty($property['image_url']) ? htmlspecialchars($property['image_url']) : 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?auto=format&fit=crop&w=400&q=80' ?>" alt="Property Image">
